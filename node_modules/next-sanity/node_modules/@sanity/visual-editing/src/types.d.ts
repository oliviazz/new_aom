...
import type { HistoryRefresh, HistoryUpdate, OverlayMsg as OverlayChannelsMsg, PresentationMsg, SanityNode, SanityStegaNode, VisualEditingMsg } from '@sanity/visual-editing-helpers';
export type { HistoryRefresh, HistoryUpdate, SanityNode, SanityStegaNode, } from '@sanity/visual-editing-helpers';
/**
 * @public
 */
 ...
 * @public
 */
export type OverlayMsg = OverlayMsgBlur | OverlayMsgActivate | OverlayMsgDeactivate | OverlayMsgElementActivate | OverlayMsgElementClick | OverlayMsgElementDeactivate | OverlayMsgElementMouseEnter | OverlayMsgElementMouseLeave | OverlayMsgElementRegister | OverlayMsgElementUnregister | OverlayMsgElementUpdateRect;
/**
 ...
 * @internal
 */
export type VisualEditingChannel = ChannelsNode<VisualEditingChannelSends, VisualEditingChannelReceives>;
/**
